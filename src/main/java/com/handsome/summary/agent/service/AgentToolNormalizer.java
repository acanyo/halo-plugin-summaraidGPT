...
import com.handsome.summary.agent.model.AgentBrowserActionType;
...
public class AgentToolNormalizer {
    ...
    public java.util.Optional<NormalizedAgentTool> normalizeCustomTool(
        ...
        var name = trimToNull(tool.name()) == null
            ? ""
            : tool.name().trim().toLowerCase(Locale.ROOT);
        ...
        var description = trimToNull(tool.description());
        if (description == null) {
